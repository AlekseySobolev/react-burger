                ...
                <section className={Styles.rightSection}>
                    ...
                    <div className={Styles.inputBox}>
                        <div className={Styles.inputWrapper}>
                            <Input name={"name"} type={"text"} placeholder={"Имя"} icon={"EditIcon"} value={form.name ? form.name : ""} onChange={onChange} />
                        </div>
                        <div className={Styles.inputWrapper}>
                            <Input name={"email"} type={"email"} placeholder={"Логин"} icon={"EditIcon"} value={form.email ? form.email : ""} onChange={onChange} />
                        </div>
                        <div className={Styles.inputWrapper}>
